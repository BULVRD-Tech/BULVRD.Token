...
contract BULVRDToken is StandardToken {

    string public name = "BULVRD Token";
    uint8 public decimals = 18;
    string public symbol = "BLVD";
    string public version = 'BLVD 0.1';
    address public mintableAddress;

    function BULVRDToken(address sale_address) {
